...
export default function Home({ params }: { params: { lang: string } }) {
  ...
  return (
    <>
      <section
        className="w-full py-12 md:py-24 lg:py-32 xl:py-48 h-[100%]"
            ...
            <div className="space-x-4">
              <a href="#services">
                <Button variant="outline">
                  {localTranslations.home.learn_more}
                </Button>
              </a>
            </div>
          </div>
      ...
      >
        <div className="container px-4 md:px-6">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-8">
            {localTranslations.home.services.title}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {localTranslations.home.services.service_list.map(
              (service, index) => {
                return (
                  <div
                    key={service.title}
          ...
          <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
            <div className="space-y-4">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">
                {localTranslations.home.about.title}
              </h2>
              <p className="text-gray-500 dark:text-gray-400">
              ...
              <div className="flex space-x-4">
                <a
                  href="https://github.com/LaurinBrechter"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/laurin-brechter/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
                >
                ...
                <a
                  href="https://medium.com/@brechterlaurin"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
                >
                  <Image
                    src="/medium-icon-svgrepo-com.svg"
                    alt="Medium"
                    width={24}
                    height={24}
                  />
          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                {localTranslations.home.contact.title}
              </h2>
